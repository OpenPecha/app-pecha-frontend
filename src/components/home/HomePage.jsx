      ...
      <Row className="justify-content-center">
        ...
        <Col lg={5} md={4} className="right-section d-flex flex-column">
          ...
          <p className="right-paragraph">
            Pecha connects users to Buddhist scriptures in various languages.
            Search a verse to explore its origins, interpretations, and related
            texts. Engage with the community by sharing insights and learning
            from others through sheets and topics.
